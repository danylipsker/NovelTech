...
namespace NovelTech.classes.Sawing
{
    public class Sawing_manager
    {
        ...
        private void set_rotate_step(double angle, string toolname = "saw")
        {
            ...
            steps.Add(new Saw_step() { action = "EP_rotation", value = temp1.Angle - UC_machine_table.instance.secondhandimagerender.Angle, tool = toolname });
        ...
        private void set_move(double x = 0, double y = 0, string toolname = "Saw")
        {
            ...
            if (x != 0)
            {
                ...
                steps.Add(new Saw_step() { action = "FA_rotation", value = UC_machine_table.instance.firsthandimagerender.Angle, tool = toolname });
                steps.Add(new Saw_step() { action = "SA_rotation", value = UC_machine_table.instance.secondhandimagerender.Angle, tool = toolname });
